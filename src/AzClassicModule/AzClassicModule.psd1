...
@{
    ...
    'Get-AzClassicDeployment', 'Get-AzClassicReservedIp', 
    'Get-AzClassicRole', 'Get-AzClassicRoleInstance', 
    'Get-AzClassicRoleInstancePowerStatus', 'Get-AzClassicService', 
    'Get-AzClassicServiceConfiguration', 'Get-AzClassicServiceInfo', 
    'Get-AzClassicStorageAccount', 'Get-AzClassicStorageKey', 
    'Get-AzResourceProviderApiVersion', 'New-AzClassicReservedIp', 
    'New-AzClassicService', 'New-AzClassicStorageAccount', 
    'Remove-AzClassicCertificate', 'Remove-AzClassicDeployment', 
    'Remove-AzClassicReservedIp', 'Remove-AzClassicService', 
    'Reset-AzClassicDeployment', 'Reset-AzClassicRoleInstance', 
    'Set-AzClassicDeployment', 'Set-AzClassicRole', 
    'Set-AzClassicServiceConfiguration', 'Switch-AzClassicDeployment'
